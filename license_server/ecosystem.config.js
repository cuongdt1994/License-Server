    ...
    apps: [
        {
            ...
            env: {
                ...
                LICENSE_TLS_PORT:       process.env.LICENSE_TLS_PORT       || process.env.TCP_PORT || '27015',
                ...
                LICENSE_TLS_HANDSHAKE_TIMEOUT_MS:
                                        process.env.LICENSE_TLS_HANDSHAKE_TIMEOUT_MS || '5000',
                LICENSE_TLS_MTLS:       process.env.LICENSE_TLS_MTLS       || '0',

                // ── Secrets — set qua env nếu muốn override; nếu để trống server tự sinh + lưu SQLite
                LICENSE_SESSION_SECRET: process.env.LICENSE_SESSION_SECRET || '',
                LICENSE_TCP_SECRET:     process.env.LICENSE_TCP_SECRET     || '',

                // ── Admin — chỉ cần lần setup đầu, sau đó lưu SQLite ───
