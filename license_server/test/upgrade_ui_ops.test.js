...
assert.match(server, /app\.post\('\/operations\/restart'/);
...
assert.match(server, /deployManager\.restartPm2Only/);
...
assert.match(operations, /Restart PM2/);
...
assert.match(operations, /\/operations\/restart/);
